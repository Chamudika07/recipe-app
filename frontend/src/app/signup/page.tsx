    ...
    >
      <div className="bg-white/90 backdrop-blur-sm p-8 rounded-lg shadow-xl max-w-md w-full mx-4">
        <div className="text-center mb-6">
          <h1 className="text-3xl font-bold text-black mb-2">🍳 Join RecipeApp</h1>
          <p className="text-black">Create your account and start sharing recipes</p>
        </div>
        ...
        <form onSubmit={handleSignup} className="flex flex-col gap-4">
          <div>
            ...
            <input
              ...
              className="w-full border border-gray-300 px-3 py-2 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent text-black"
              value={email}
